...
Laravel akan membuat file migration baru di folder `database/migrations` dengan format nama
```bash
YYYY_MM_DD_HHMMSS_create_customers_table.php
```.
Format timestamp ini penting karena menentukan urutan eksekusi migration.
