...
const periodSchema = z.object({ start: z.string().min(1), end: z.string().optional() });
...
const portfolioSchema = z.object({
    site: z.object({
        ...
        logo: z.object({ src: z.string().optional(), alt: z.string().optional() }).optional(),
    }),
    sections: z.object({
        profile: z.boolean(),
    ...
    socialLinks: z.array(
        z.object({
            ...
            description: z.string().min(1),
            href: z.string().url(),
            placements: z.array(z.enum(["home", "linksPrimary", "linksSecondary"])).default([]),
        }),
    ),
    linkPage: z.object({
        title: z.string().min(1),
...
const portfolio = {
    site: {
        ...
        url: "https://fadils.web.id",
        description:
            "Portfolio of Wahyu Akhmad Fadillah — Full Stack Developer specializing in Next.js, TypeScript and modern web tooling.",
        language: "en",
        locale: "en_US",
        themeColor: { light: "#ffffff", dark: "#0a0a0a" },
        repositoryUrl: "https://github.com/fadilsflow/dporto1408",
        logo: { src: "", alt: "Wahyu Akhmad Fadillah logo" },
    },
    sections: {
        profile: true,
        socialLinks: true,
    ...
    navigation: [
        {
            title: "Portfolio",
            href: "/",
            icon: "M3 10.5 12 3l9 7.5M5 10v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-9M9 21v-6h6v6",
        },
        {
            title: "Link",
            href: "/link",
            icon: "M10 13a5 5 0 0 0 7.07 0l2.12-2.12a5 5 0 0 0-7.07-7.07L11 4.93M14 11a5 5 0 0 0-7.07 0L4.81 13.12a5 5 0 0 0 7.07 7.07L13 19.07",
        },
        {
            title: "Resume",
            href: "/resume",
    ...
    profile: {
        ...
        address: {
            label: "Tegal, Jawa Tengah, Indonesia",
            locality: "Tegal",
            region: "Jawa Tengah",
            country: "ID",
        },
...
`,
    ...
    linkPage: {
        ...
        primaryLinks: [
            { title: "portfolio", href: "/", external: false },
            { title: "resume", href: "/resume", external: false },
        ],
        secondaryLinks: [],
    },
    resume: {
        title: "Resume",
        description: "My professional resume showcasing experience, skills, and education.",
        seoDescription:
            "Professional resume of Wahyu Akhmad Fadillah — Full Stack Developer with 2+ years building production-ready, scalable web applications using Next.js and TypeScript.",
        embedUrl: "https://drive.google.com/file/d/1lqikfdBvA24I6XRtXlsHYnU2jg2Bw2DQ/preview",
        downloadUrl: "",
    },
    projects: {
        initialVisible: 4,
        items: [
            {
                ...
                skills: ["TanStack Start", "React 19", "TypeScript", "Tailwind CSS", "PostgreSQL", "Drizzle ORM", "tRPC", "Midtrans"],
            ...
            },
            {
                ...
                skills: ["Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "Cloudinary", "Drizzle ORM", "Midtrans"],
            ...
            },
            {
                ...
                skills: ["Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "Drizzle ORM", "Better Auth", "Zustand"],
            ...
            },
            {
                ...
                skills: ["Next.js", "TypeScript", "Tailwind CSS", "Google AI SDK", "Clerk", "Zustand"],
            ...
            },
            {
                ...
                skills: ["Next.js", "TypeScript", "React Query", "Zustand", "Tailwind CSS", "shadcn/ui"],
            ...
            },
            {
                ...
                skills: ["Next.js", "Prisma", "PostgreSQL", "Clerk", "Cloudinary", "shadcn/ui"],
...
- Contribute to system functionality improvements through debugging, testing, and continuous refinement based on project requirements.`,
                    icon: "code",
                    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "API Integration", "Database Management"],
                },
            ],
        },
        {
...
- Actively involved in system architecture planning and long-term development strategy alongside the management team.`,
                    icon: "code",
                    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "Teamwork", "Problem-solving", "Project Management"],
                },
            ],
        },
        {
...
- Integrated [Midtrans](https://midtrans.com) payment gateway for seamless transactions and automated seller remittance.`,
                    icon: "code",
                    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "shadcn/ui", "Midtrans", "PostgreSQL", "Drizzle", "Zustand", "Tanstack Query"],
                },
            ],
        },
        {
...
- Collaborated with backend team and stakeholders to ensure efficient data flow and timely project deliverables.`,
                    icon: "code",
                    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "shadcn/ui", "React Query", "Zustand"],
                },
            ],
        },
        {
...
- Documented the club's activities and events.`,
                    icon: "design",
                    skills: ["Graphic Design", "Social Media Management", "Content Creation"],
                },
            ],
        },
        {
...
- Handled API design, UI development, database modeling, and deployment.`,
                    icon: "code",
                    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "Drizzle", "Prisma", "Supabase", "shadcn/ui", "Gemini API"],
                },
                {
                    id: "freelance-design",
...
- Delivered responsive UI prototypes and collaborated with developers for implementation.`,
                    icon: "design",
                    skills: ["UI/UX Design", "Wireframing", "Figma", "Prototyping", "Graphic Design"],
                },
            ],
        },
        {
            ...
            positions: [
                {
                    id: "edu-uhn",
                    title: "Universitas Harkat Negeri — Applied Bachelor (D4) Informatics Engineering",
...
- Led the Creative Team for PKKMB 2024, overseeing event branding, media production, and visual design.`,
                    skills: ["Web Programming", "Mobile Programming", "Database Design", "Software Engineering", "Artificial Intelligence"],
                },
                {
                    id: "edu-smk",
...
- Graduated with a strong interest in transitioning multimedia knowledge into web development and software engineering.`,
                    skills: ["Multimedia Production", "Adobe Photoshop", "Adobe Illustrator", "Adobe Premiere"],
                },
            ],
        },
    ],
    techStack: [
        ...
        { key: "php", title: "PHP", href: "https://www.php.net/", categories: ["Language"] },
        ...
        { key: "bun", title: "Bun", href: "https://bun.sh/", categories: ["Runtime Environment"] },
        { key: "react", title: "React", href: "https://react.dev/", categories: ["Library", "UI Library"] },
        { key: "nextjs2", title: "Next.js", href: "https://nextjs.org/", categories: ["Framework"], theme: true },
        { key: "tailwindcss", title: "Tailwind CSS", href: "https://tailwindcss.com/", categories: ["Framework"] },
        { key: "shadcn-ui", title: "shadcn/ui", href: "https://ui.shadcn.com/", categories: ["Library", "Component Library"], theme: true },
        ...
        { key: "redux", title: "Redux", href: "https://redux.js.org/", categories: ["State Management"] },
        ...
        { key: "laravel", title: "Laravel", href: "https://laravel.com/", categories: ["Framework"] },
        ...
        { key: "figma", title: "Figma", href: "https://www.figma.com/", categories: ["Tools", "Design"] },
        { key: "ps", title: "Adobe Photoshop", href: "https://www.adobe.com/vn_en/products/photoshop.html", categories: ["Tools", "Design"] },
        { key: "chatgpt", title: "ChatGPT", href: "https://chatgpt.com/", categories: ["Tools", "AI"], theme: true },
    ],
    footer: {
        builtByLabel: "fadil",
        builtByHref: "https://github.com/fadilsflow",
        sourceCodeLabel: "GitHub",
        sourceCodeUrl: "https://github.com/fadilsflow/dporto1408",
    },
} satisfies z.input<typeof portfolioSchema>;
